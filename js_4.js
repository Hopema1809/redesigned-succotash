  ...
  var popupSelect = new OpenLayers.Control.SelectFeature(layers,
    {
      onSelect: function(feature) {
        ...
        jQuery('<div/>', {
          id : 'popup-temp',
          style : 'width: 202px;font-size: 14px;line-height: 18px;font-weight: bold !important;'
        }).appendTo('body');
        jQuery('#popup-temp').hide();
        jQuery(Drupal.theme('openlayersPopup', feature)).appendTo('#popup-temp')
        var popupHeight = jQuery('#popup-temp').height();
        var popupHeightAdd = 80;
        jQuery('#popup-temp').remove();
        popup.maxSize = popup.minSize = new OpenLayers.Size(250, popupHeight+popupHeightAdd);
